...
export const BADGE_DEFINITIONS: Record<BadgeType, BadgeDefinition> = {
  ...
  TIER_BRONCE: {
    type: 'TIER_BRONCE',
    name: 'Tier Bronce',
    description: 'Alcanza el tier Bronce',
    icon: '🥉',
  ...
  TIER_PLATA: {
    type: 'TIER_PLATA',
    name: 'Tier Plata',
    description: 'Alcanza el tier Plata',
    icon: '🥈',
  ...
  TIER_ORO: {
    type: 'TIER_ORO',
    name: 'Tier Oro',
    description: 'Alcanza el tier Oro',
    icon: '🥇',
    color: 'bg-yellow-100 text-yellow-700',
  },
  TIER_PLATINO: {
    type: 'TIER_PLATINO',
    name: 'Tier Platino',
    description: 'Alcanza el tier Platino',
    icon: '💎',
  ...
  TIER_DIAMANTE: {
    type: 'TIER_DIAMANTE',
    name: 'Tier Diamante',
    description: 'Alcanza el tier Diamante - elite del tenis amateur',
    icon: '💠',
