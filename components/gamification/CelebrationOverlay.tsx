...
export function CelebrationOverlay() {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center">
      ...
      {/* Modal */}
      <div className="relative bg-card border border-border rounded-2xl shadow-2xl max-w-sm w-full mx-4 overflow-hidden animate-in zoom-in-95 duration-300">
        <button
          onClick={dismissCelebration}
        ...
        <div className="bg-gradient-to-br from-primary/20 to-primary/5 px-6 py-10 text-center">
